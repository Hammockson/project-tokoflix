    ...
    return (
      <div>
        <Container style={{marginTop: 70}}>
            ...
            <Row>
                <Col md={4} className="ashadow2"><img src={'https://image.tmdb.org/t/p/w300' + this.state.movposter}/></Col>
                <Col md={8} className="ashadow">
                    ...
                    <div className="fmini">
                        ...
                        <Row style={{marginTop:50}}>
                            ...
                            <p>Your Balance Rp.{this.state.balance}</p>
                            <b><h6>{this.state.movprice}</h6></b>
